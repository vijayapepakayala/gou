    ...
    generateAccountPDF(accountId) {
        return new Promise((resolve, reject) => {
            ...
            const createPDF = async () => {
                const pdfMake = await import('https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.1.68/pdfmake.min.js');
                const pdfFonts = await import('https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.1.68/vfs_fonts.js');
                pdfMake.default.vfs = pdfFonts.default;
                const pdfData = pdfMake.default.createPdf(documentDefinition);
                resolve(pdfData);
            };
